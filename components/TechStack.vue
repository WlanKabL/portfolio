<template>
    <section class="py-32 max-w-7xl mx-auto px-4 relative">
        ...
        <div class="relative z-10">
            <h2
                class="text-4xl md:text-5xl font-bold mb-6 text-center text-gradient scroll-hidden"
                ref="titleRef"
            >
                {{ $t("tech_stack.title") }}
            </h2>
            ...
            <p
                class="text-xl text-gray-400 text-center mb-16 max-w-3xl mx-auto scroll-hidden"
                ref="subtitleRef"
            >
                A comprehensive arsenal of modern technologies and tools that power my development
                workflow
            </p>
