<template>
    <section class="relative min-h-screen flex items-center justify-center text-center px-4">
        ...
        <div class="relative z-10 max-w-5xl mx-auto">
            ...
            <div class="mb-12">
                <h1
                    class="text-4xl sm:text-6xl lg:text-7xl font-bold text-white leading-tight mb-6 scroll-hidden"
                    ref="heroTitle"
            ...
            <div class="mb-16 scroll-hidden" ref="subtitle" style="animation-delay: 0.4s">
                ...
                <div class="flex flex-wrap justify-center gap-3 mt-8">
                    <span
                        class="px-4 py-2 glass rounded-full text-sm font-medium text-purple-200 border border-purple-500/30"
                    >
