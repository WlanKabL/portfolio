<template>
    ...
    >
        ...
        >
            ...
            <div
                class="absolute inset-0 bg-gradient-to-br from-black/80 via-purple-900/60 to-black/90"
            />
            <div
        ...
        <div class="relative z-10 max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                <h1
                    class="text-5xl sm:text-7xl font-black text-white leading-tight mb-4 scroll-hidden"
                    ref="heroTitle"
            ...
            <!-- Subtitle -->
            <p
                class="text-xl sm:text-2xl text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed scroll-hidden"
                ref="subtitle"
            ...
            <!-- CTA Buttons -->
            <div
                class="flex flex-col sm:flex-row gap-6 justify-center items-center scroll-hidden"
                ref="ctaButtons"
            ...
            <!-- Scroll Indicator -->
            <div
                class="absolute bottom-8 left-1/2 transform -translate-x-1/2 scroll-hidden"
