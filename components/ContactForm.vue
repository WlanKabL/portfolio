    ...
    <section class="py-32 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div class="max-w-2xl mx-auto relative z-10">
            <div class="glass-strong p-10 rounded-3xl shadow-2xl border border-purple-500/30">
                <h2
                    class="text-4xl md:text-5xl font-bold text-center text-gradient mb-4 scroll-hidden"
                    ref="titleRef"
                >
                    {{ title }}
                </h2>
                ...
                <form class="space-y-6 scroll-hidden" @submit.prevent="sendMessage" ref="formRef">
                    <div class="relative">
                        ...
                        />
                        <div
                            class="absolute inset-0 rounded-xl bg-purple-500/5 opacity-0 focus-within:opacity-100 transition-opacity duration-300 pointer-events-none"
                        ></div>
                    </div>
                ...
                >
                    <div
                        v-if="success"
                        class="mt-6 p-4 glass rounded-xl border border-green-500/30"
                    >
