<template>
    <section class="py-32 max-w-7xl mx-auto px-4 relative">
        ...
        <div class="relative z-10">
            <h2 v-if="title" class="text-4xl md:text-5xl font-bold text-center mb-4 text-gradient scroll-hidden" ref="titleRef">
                {{ title }}
            </h2>
            
            <p class="text-xl text-gray-400 text-center mb-16 max-w-2xl mx-auto scroll-hidden" ref="subtitleRef">
            ...
            <div class="text-center mt-16 scroll-hidden" ref="ctaRef">
                <NuxtLink to="/projects" class="apple-button inline-flex items-center gap-3 text-lg">
