<template>
    <section class="py-32 relative">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto px-4 relative z-10">
            <!-- Portrait Section -->
            <div class="relative group mx-auto lg:mx-0 scroll-hidden" ref="portrait">
                <!-- Glow Effect -->
                <div class="absolute inset-0 bg-purple-600 blur-3xl opacity-20 group-hover:opacity-40 transition-all duration-500 rounded-3xl animate-glow-pulse" />
                ...
                <div class="relative">
                    ...
                    <!-- Floating Tech Icons -->
                    <div class="absolute -top-4 -right-4 w-12 h-12 bg-purple-600 rounded-xl flex items-center justify-center shadow-lg animate-float" style="animation-delay: 0.5s">
                        <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 0l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-3.01L12 0z"/>
                        </svg>
                    </div>
                    
                    <div class="absolute -bottom-4 -left-4 w-12 h-12 bg-purple-700 rounded-xl flex items-center justify-center shadow-lg animate-float" style="animation-delay: 1s">
                        <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="scroll-hidden" ref="content">
                ...
                <div class="space-y-6">
                    <div 
                        ...
                        ref="featureItems"
                    >
                        <div class="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-700 rounded-lg flex items-center justify-center shadow-lg">
